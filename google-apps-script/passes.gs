// ── Constants ──
const SHEET_DATA = "Passes"; // adjust if the tab is named differently

const ROW_START = 6;

const COL_NAME = 1; // A  — pass name (layout reference)
const COL_JSON_URL = 9; // I  — steam priceoverview URL (price matching)
const COL_CURRENT_PRICE = 10; // J  — current unit price (written by fetch)
...
function updateFromGitHub() {
  ...
  // rows without a URL are section headers / blanks
